          ...
          <div className="contact__content">
            ...
            <div className="contact__info">
              <div className="contact__card">
                ...
                <a
                  href="mailto:js.muratavci@gmail.com"
                  target="_blank"
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">+905425390506</span>
                  <a
                    href="https://api.whatsapp.com/send?phone=905425390506&text=Hello, more information!"
                    target="_blank"
                    className="contact__button"
                    rel="noreferrer"
                  >
              ...
              <div className="contact__info">
                <div className="contact__card">
                  ...
                  <span className="contact__card-data">Murat AVCI</span>
                  <a
                    href="https://m.me//"
                    className="contact__button"
                    target="_blank"
